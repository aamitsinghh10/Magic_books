...
<head>
    ...
    <link href="${pageContext.servletContext.contextPath}/resources/css/register.css" rel="stylesheet" type="text/css">
    <style>
        .error {
            color: red;
        }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.servletContext.contextPath}/">Books</a>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form action="${pageContext.servletContext.contextPath}/register" method="POST">
                ...
                <div class="mb-3">
                    <input type="password" id="confirm_password" class="form-control" name="confirm_password" placeholder="Confirm Password" value="" required/>
                </div>
